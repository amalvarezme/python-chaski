...
class TestDiscovery(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_single_server_connect_discovery(self):
        ...
        await asyncio.sleep(0.3)
        self.assertEqual(len(nodes[0].edges), 2, f"Node 0 discovery failed after discovery")
        self.assertEqual(len(nodes[1].edges), 2, f"Node 1 discovery failed after discovery")
        self.assertEqual(len(nodes[2].edges), 2, f"Node 2 discovery failed after discovery")
    ...
    async def test_single_discovery_with_disconnection(self):
        ...
        await asyncio.sleep(0.3)
        self.assertEqual(len(nodes[0].edges), 1, f"Node 0 discovery failed after discovery")
        self.assertEqual(len(nodes[1].edges), 2, f"Node 1 discovery failed after discovery")
        self.assertEqual(len(nodes[2].edges), 1, f"Node 2 discovery failed after discovery")
    ...
    async def test_multiple_discovery(self):
        ...
        await asyncio.sleep(0.3)
        self.assertEqual(len(nodes[0].edges), 6, f"Node 0 discovery failed after discovery")
        self.assertEqual(len(nodes[1].edges), 6, f"Node 1 discovery failed after discovery")
        self.assertEqual(len(nodes[2].edges), 2, f"Node 2 discovery failed after discovery")
        self.assertEqual(len(nodes[3].edges), 2, f"Node 3 discovery failed after discovery")
        self.assertEqual(len(nodes[4].edges), 2, f"Node 4 discovery failed after discovery")
        self.assertEqual(len(nodes[5].edges), 2, f"Node 5 discovery failed after discovery")
        self.assertEqual(len(nodes[6].edges), 2, f"Node 6 discovery failed after discovery")
